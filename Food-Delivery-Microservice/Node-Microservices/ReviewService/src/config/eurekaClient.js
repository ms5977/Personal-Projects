...
const client = new Eureka({
    instance: {
        instanceId: 'ReviewService',
        app: 'ReviewService', // app name as string
        hostName: 'localhost',
        ipAddr: '127.0.0.1',
        port: {
            '$': 5300, // port should be an object with `$` property for non-secure port
            '@enabled': true // enable the port
        },
        vipAddress: 'ReviewService',
        secureVipAddress: 'ReviewService',
        dataCenterInfo: {
