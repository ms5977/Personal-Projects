...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<Map<String, Object>> handleHttpClientErrorException(HttpClientErrorException ex) {
		...
		if (ex.getStatusCode() == HttpStatus.NOT_FOUND) {
			errors.put("message", "The requested resource not found.");
	...
	public ResponseEntity<?> handleFeignException(FeignException.NotFound ex) {
		logger.error("Feign exception: {}", ex.getMessage());
		String message = "The requested resource not found in the external service. Unable to create or associate menus.";
